...
--------------------------------------------------------------------`;
  ...
  return (
    <div className="w-full bg-[#FBF9F5] text-[#102A43] font-sans antialiased min-h-screen selection:bg-[#C2672B] selection:text-white overflow-x-hidden">
      {/* 1. MAIN NAVIGATION BAR */}
      <header className="w-full relative z-40 bg-[#FBF9F5] border-b border-[#102A43]/10 px-4 py-6 sm:py-7 shadow-sm">
        <div className="w-full flex items-center justify-between gap-6">
          {/* Brand Logo */}
          <Link to="/" className="flex items-center gap-3.5 group shrink-0">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white flex items-center justify-center shadow-lg border border-[#102A43]/15 overflow-hidden transition-all transform group-hover:scale-105 p-1">
              <img src="/maapsetu_icon.png" alt="MaapSetu Logo" className="w-full h-full object-contain" />
            </div>
            <div className="flex items-baseline">
              <span className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#102A43] font-serif">
                Maap
              </span>
              <span className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#B85D19] font-serif italic">
                Setu
              </span>
            </div>
          </Link>
          ...
          {/* Desktop Nav Links */}
          <nav className="hidden lg:flex items-center gap-8 xl:gap-10 text-base sm:text-lg font-bold text-[#102A43]">
            {/* User Portals Dropdown */}
            <div className="relative group">
              <button
                type="button"
                className="flex items-center gap-2 hover:text-[#B85D19] transition-colors py-2 font-extrabold"
              >
                <span>User Portals</span>
                <ChevronDown className="w-5 h-5 text-[#102A43]/70 group-hover:text-[#B85D19] transition-transform group-hover:rotate-180" />
              </button>

              {/* Mega Menu Dropdown */}
              <div className="absolute top-full -left-12 w-[580px] bg-[#FBF9F5] border border-[#102A43]/15 rounded-3xl shadow-2xl p-7 hidden group-hover:grid grid-cols-2 gap-8 z-50 animate-in fade-in duration-150">
                <div className="space-y-4">
                  <p className="text-xs uppercase font-extrabold tracking-wider text-[#B85D19] flex items-center gap-2 pb-2 border-b border-[#102A43]/10">
                    <Building2 className="w-4 h-4" /> Instrument Owners
                  </p>
                  <ul className="space-y-3 text-xs sm:text-sm text-[#102A43]/90">
                    <li>
                      <Link
                        to="/login?role=business"
                        className="hover:text-[#B85D19] font-bold block text-base"
                      >
                    ...
                    <li>
                      <Link
                        to="/login?role=business"
                        className="hover:text-[#B85D19] block font-medium"
                      >
                        Register Instrument
                      </Link>
                    </li>
            ...
            <div className="relative group">
              <button
                type="button"
                className="flex items-center gap-1.5 hover:text-[#B85D19] transition-colors py-2 font-extrabold text-[#102A43]"
              >
                <BookOpen className="w-5 h-5 text-[#B85D19]" />
                <span>Act & Rules</span>
                <ChevronDown className="w-4 h-4 text-[#102A43]/70 group-hover:text-[#B85D19] transition-transform group-hover:rotate-180" />
              </button>

              {/* Act & Rules Hover Popover Menu */}
              <div className="absolute top-full right-0 lg:-left-24 w-[420px] bg-[#FBF9F5] border border-[#102A43]/20 rounded-2xl shadow-2xl p-5 hidden group-hover:block z-50 animate-in fade-in duration-150 space-y-4">
                <div className="pb-3 border-b border-[#102A43]/10 flex items-center justify-between">
                  <span className="text-xs font-extrabold uppercase tracking-wider text-[#B85D19] flex items-center gap-1.5">
                    <BookOpen className="w-4 h-4" /> Official Legal Framework
                  </span>
                  <span className="text-[10px] bg-[#102A43]/10 text-[#102A43] px-2 py-0.5 rounded font-mono font-bold">
                    GOVT GAZETTE
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  {actAndRulesList.map((doc) => (
                    <div
                      key={doc.id}
                      className="p-3.5 bg-white rounded-xl border border-[#102A43]/10 space-y-2 hover:border-[#B85D19]/40 transition-colors"
                    >
                      <div>
                        <h4 className="font-serif font-bold text-[#102A43] text-sm sm:text-base leading-snug">
                          {doc.title}
                        </h4>
                        <p className="text-xs text-[#102A43]/70 leading-relaxed mt-0.5">
                          {doc.desc}
                        </p>
                      </div>
                      <div className="flex items-center justify-end gap-2 pt-1 border-t border-[#102A43]/5">
                        <button
                          type="button"
                          onClick={() => setViewingDoc(doc)}
                          className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-[#FDF3EC] text-[#102A43] font-bold text-xs hover:bg-[#B85D19] hover:text-white transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-[#102A43] text-white font-bold text-xs hover:bg-[#0A1C2E] transition-colors"
                        >
                          <Download className="w-3.5 h-3.5 text-[#C2672B]" />
                          <span>Download</span>
                        </button>
                      </div>
                    </div>
            ...
            <a
              ...
              className="hover:text-[#B85D19] font-extrabold transition-colors text-[#B85D19]"
            >
            ...
            <a
              ...
              className="hover:text-[#B85D19] transition-colors font-bold"
            >
              Core Modules
            </a>
          ...
          <div className="flex items-center gap-4">
            <Link
              to="/login"
              className="dashed-border-btn inline-flex items-center gap-3 px-8 py-3.5 rounded-full bg-[#FDF3EC] text-[#102A43] font-extrabold text-base sm:text-lg hover:bg-[#B85D19] hover:text-white transition-all shadow-sm"
            >
              <span>Portal Login</span>
              <div className="w-7 h-7 rounded-full bg-[#102A43] text-white flex items-center justify-center text-sm group-hover:bg-white group-hover:text-[#B85D19] transition-colors">
            ...
            <button
              ...
              className="lg:hidden p-3 rounded-2xl text-[#102A43] hover:bg-[#102A43]/10 transition-colors"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-[#FBF9F5] border-t border-[#102A43]/10 px-6 py-8 space-y-5 shadow-2xl animate-in slide-in-from-top duration-200">
            <Link
              to="/login?role=business"
              onClick={() => setMobileMenuOpen(false)}
              className="block text-lg font-bold text-[#B85D19] py-2 border-b border-[#102A43]/10"
            >
              Business Owner Portal
            </Link>
            <Link
              to="/login?role=lmd"
              onClick={() => setMobileMenuOpen(false)}
              className="block text-lg font-bold text-[#102A43] py-2 border-b border-[#102A43]/10"
            >
              LMD Administrator Portal
            </Link>
            <Link
            ...
            <div className="py-2 border-b border-[#102A43]/10 space-y-3">
              <span className="block text-lg font-bold text-[#102A43]">
                Act & Rules
              </span>
              <div className="space-y-2 pl-2">
                {actAndRulesList.map((doc) => (
                  <div
                    key={doc.id}
                    className="p-3 bg-white rounded-xl border border-[#102A43]/10 space-y-1.5"
                  >
                    <p className="font-bold text-xs text-[#102A43]">
                      {doc.title}
                    </p>
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-2.5 py-1 bg-[#FDF3EC] text-[#102A43] font-bold text-[11px] rounded"
                      >
                        View
                      </button>
                      <button
                        type="button"
                        onClick={(e) => handleDownloadDoc(e, doc)}
                        className="px-2.5 py-1 bg-[#102A43] text-white font-bold text-[11px] rounded"
                      >
                        Download
                      </button>
                    </div>
            ...
            <a
              href="#faq"
              onClick={(e) => handleSmoothScroll(e, "faq")}
              className="block text-lg font-bold text-[#102A43] py-2"
            >
              FAQ
            </a>
          </div>
      ...
      {/* 2. HERO SECTION */}
      <section className="w-full pt-12 pb-24 px-6 sm:px-12 lg:px-20 2xl:px-24 bg-[#FBF9F5] relative overflow-hidden">
        <div className="w-full max-w-6xl mx-auto text-center space-y-6 relative z-10">
          {/* Main Hero Headline */}
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-serif font-bold text-[#102A43] tracking-tight leading-[1.08]">
              Making Instrument Verification <br className="hidden sm:inline" />
              <span className="relative inline-block font-serif italic text-[#B85D19]">
                Simple
                <svg
                  viewBox="0 0 257 20"
                  fill="none"
                  className="absolute left-0 -bottom-3 w-full h-6 text-[#B85D19]"
                >
                  <path
          ...
          {/* Subtitle */}
          <p className="max-w-4xl mx-auto text-base sm:text-xl text-[#102A43]/85 leading-relaxed font-normal">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link
              to="/login?role=business"
              className="dashed-border-btn inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-[#FDF3EC] text-[#102A43] font-bold text-base hover:bg-[#B85D19] hover:text-white transition-all shadow-md"
            >
              <Camera className="w-5 h-5 text-[#B85D19] group-hover:text-white" />
            ...
            <Link
              ...
              className="dashed-border-btn inline-flex items-center gap-2.5 px-8 py-4 rounded-full bg-white text-[#102A43] font-bold text-base hover:border-[#B85D19] hover:text-[#B85D19] transition-all shadow-md"
            >
              <FileText className="w-5 h-5 text-[#102A43]" />
        ...
        <div className="w-full max-w-[1500px] mx-auto mt-12 px-2 sm:px-4 relative">
          <div className="w-full bg-white rounded-3xl p-4 sm:p-8 shadow-xl border border-[#102A43]/15 relative overflow-hidden">
            <img
      ...
      <section className="w-full py-6 border-y border-[#102A43]/10 bg-white/60 overflow-hidden">
        <div className="w-full px-4 mb-3 text-center">
          <p className="text-[11px] font-bold tracking-widest text-[#102A43]/50 uppercase">
        ...
        <div className="flex overflow-hidden whitespace-nowrap space-x-12 select-none py-2">
          <div className="flex space-x-12 items-center text-[#102A43]/70 font-bold text-sm tracking-wider animate-marquee">
          ...
          <div
            className="flex space-x-12 items-center text-[#102A43]/70 font-bold text-sm tracking-wider animate-marquee"
            aria-hidden="true"
          >
            <span>BUILT AROUND MINISTRY OF CONSUMER AFFAIRS</span> •{" "}
            <span>BUILT AROUND LEGAL METROLOGY ACT, 2009</span> •{" "}
      ...
      >
        <div className="text-center space-y-3 max-w-5xl mx-auto">
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-bold text-[#102A43]">
            Verification workflows{" "}
            <em className="italic text-[#B85D19]">tailored to your role</em>
          </h2>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="card-hover-tilt group relative bg-white rounded-3xl p-8 sm:p-10 border-2 border-dashed border-[#102A43]/20 hover:border-[#B85D19] shadow-xs flex flex-col justify-between">
            <div className="space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-[#B85D19]/10 text-[#B85D19] flex items-center justify-center font-bold">
            ...
            <div className="pt-8">
              <Link
                to="/login?role=lmd"
                className="inline-flex items-center gap-2 text-sm sm:text-base font-bold text-[#B85D19] group-hover:underline"
              >
          ...
          <div className="card-hover-tilt group relative bg-[#EAF6F8] rounded-3xl p-8 sm:p-10 border-2 border-dashed border-[#B85D19]/30 hover:border-[#B85D19] shadow-xs flex flex-col justify-between">
            <div className="space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-[#B85D19] text-white flex items-center justify-center font-bold">
      ...
      <section
        id="rules"
        className="w-full py-20 px-6 sm:px-12 lg:px-20 2xl:px-24 bg-white border-y border-[#102A43]/10"
      >
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FDF3EC] text-[#B85D19] text-xs font-bold uppercase tracking-wider">
              <ShieldCheck className="w-4 h-4" /> Platform Guarantee
            </div>
            <h2 className="text-3xl sm:text-5xl font-serif font-bold text-[#102A43] leading-tight">
              Legal Metrology is{" "}
              <em className="italic text-[#B85D19]">complex</em>, but your
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="p-6 bg-[#FBF9F5] rounded-2xl border border-[#102A43]/10 space-y-2 hover:border-[#B85D19] transition-colors">
              <QrCode className="w-7 h-7 text-[#B85D19]" />
              <h4 className="font-bold text-[#102A43] text-lg">
                Tamper-Proof QR Stamps
              </h4>
              <p className="text-xs sm:text-sm text-[#102A43]/70">
                Verifiable digital certificates with instant QR lookup.
              </p>
            </div>

            <div className="p-6 bg-[#FBF9F5] rounded-2xl border border-[#102A43]/10 space-y-2 hover:border-[#B85D19] transition-colors">
              <Clock className="w-7 h-7 text-[#B85D19]" />
              <h4 className="font-bold text-[#102A43] text-lg">
            ...
            <div className="p-6 bg-[#FBF9F5] rounded-2xl border border-[#102A43]/10 space-y-2 hover:border-[#B85D19] transition-colors">
              <Award className="w-7 h-7 text-[#B85D19]" />
              <h4 className="font-bold text-[#102A43] text-lg">
                GATC & LMO Roster
              </h4>
              <p className="text-xs sm:text-sm text-[#102A43]/70">
      ...
      >
        <div className="w-full bg-[#102A43] text-white rounded-3xl p-8 sm:p-14 shadow-2xl border border-[#B85D19]/40 relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#B85D19]/30 text-emerald-300 text-xs font-semibold">
              ...
              <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-bold leading-tight">
                ...
                <span className="text-[#C2672B] italic">
                  Certificate & Lead Seal
                </span>
              </h2>

              <p className="text-base sm:text-lg text-[#FDF3EC]/85 leading-relaxed">
              ...
              <div className="flex flex-wrap gap-4 text-xs sm:text-sm text-[#FDF3EC]">
            ...
            <div className="lg:col-span-5 bg-[#FBF9F5] text-[#102A43] p-6 sm:p-8 rounded-2xl shadow-xl border border-[#102A43]/20 space-y-4">
              ...
              <form onSubmit={handleSearchVerify} className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold uppercase tracking-wider text-[#102A43]/70 mb-1">
                    Instrument Category
                  </label>
                  <select
                    value={searchCategory}
                    onChange={(e) => setSearchCategory(e.target.value)}
                    className="w-full bg-white border border-[#102A43]/20 rounded-lg p-2.5 text-xs font-semibold text-[#102A43]"
                  >
                ...
                <div>
                  <label className="block text-xs font-semibold text-[#102A43]/70 mb-1">
                    Certificate ID
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-white border border-[#102A43]/20 rounded-lg p-2.5 text-xs font-mono font-bold uppercase text-[#102A43]"
                  />
                  <p className="text-[10px] text-[#102A43]/60 mt-1">
                    Try demo IDs:{" "}
                    <button
                      type="button"
                      onClick={() => setSearchCertId("CERT-2026-8891")}
                      className="text-[#B85D19] underline"
                    >
                      CERT-2026-8891
                    </button>{" "}
                    (Valid) or{" "}
                ...
                {lookupResult && (
                  <div className="p-4 bg-[#FDF3EC] rounded-xl border border-[#B85D19]/30 text-xs space-y-1.5">
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 rounded-full bg-[#B85D19] hover:bg-[#102A43] text-[#FBF9F5] font-semibold text-sm transition-colors shadow-md flex items-center justify-center gap-2"
                >
      ...
      <section
        id="faq"
        className="w-full py-24 px-6 sm:px-12 lg:px-20 2xl:px-24 bg-white border-t border-[#102A43]/10"
      >
        <div className="w-full space-y-10">
          <div className="text-center space-y-3">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-[#102A43]">
              Frequently Asked Questions
            </h2>
            <p className="text-base sm:text-xl text-[#102A43]/70 font-normal">
              ...
              return (
                <div
                  ...
                  className={`w-full border rounded-2xl overflow-hidden transition-all duration-300 shadow-xs ${
                    isOpen
                      ? "border-[#B85D19] bg-[#FBF9F5] shadow-md ring-1 ring-[#B85D19]/30"
                      : "border-[#102A43]/15 bg-white hover:border-[#B85D19]/40 hover:bg-[#FBF9F5]/50"
                  }`}
                >
                  <button
                    type="button"
                    onClick={() => setActiveFaq(isOpen ? null : idx)}
                    className="w-full px-8 py-6 text-left flex items-center justify-between gap-6 font-serif font-bold text-lg sm:text-xl text-[#102A43] transition-colors"
                  >
                    <span>{faq.q}</span>
                    <div
                      className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 transition-transform duration-300 ${
                        isOpen
                          ? "bg-[#B85D19] text-white rotate-180"
                          : "bg-[#FDF3EC] text-[#102A43]"
                      }`}
                    >
                  ...
                  >
                    <div className="overflow-hidden">
                      <div className="px-8 pb-7 pt-2 text-base sm:text-lg text-[#102A43]/85 leading-relaxed border-t border-[#102A43]/10 font-normal">
                        {faq.a}
                      </div>
                    </div>
                  </div>
      ...
      {/* 9. FOOTER CTA BANNER */}
      <footer id="contact" className="w-full bg-[#0A1C2E] text-[#FDF3EC] py-16">
        <div className="w-full px-6 sm:px-12 lg:px-20 2xl:px-24">
          <div className="w-full bg-[#102A43] p-8 sm:p-14 rounded-3xl border border-[#B85D19]/40 text-center space-y-6 shadow-2xl relative">
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-bold text-white">
              Digitizing trust in{" "}
              <em className="italic text-[#C2672B]">every measurement</em>
            </h2>
            <p className="text-sm sm:text-base text-[#FDF3EC]/80 max-w-xl mx-auto">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-2 relative z-20">
              <Link
                to="/login?role=business"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#C2672B] hover:bg-white text-[#102A43] font-bold text-base transition-colors shadow-lg"
              >
      ...
      {viewingDoc && (
        <div className="fixed inset-0 z-50 bg-[#102A43]/80 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200">
          <div className="w-full max-w-4xl bg-[#FBF9F5] text-[#102A43] rounded-3xl shadow-2xl border border-[#B85D19]/40 max-h-[90vh] flex flex-col overflow-hidden">
            {/* Modal Header */}
            <div className="p-6 bg-[#102A43] text-white flex items-center justify-between border-b border-[#B85D19]/30 shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[#C2672B] text-[#102A43] flex items-center justify-center font-bold">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#FDF3EC]/80 flex items-center gap-2">
            ...
            <div className="p-6 sm:p-8 overflow-y-auto space-y-6 flex-1 text-sm sm:text-base leading-relaxed">
              <div className="p-4 bg-[#FDF3EC] border border-[#B85D19]/30 rounded-2xl flex items-start gap-3">
                <ShieldCheck className="w-6 h-6 text-[#B85D19] shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-[#102A43] text-sm">
                    Official Legal Metrology Department Reference
                  </h4>
                  <p className="text-xs text-[#102A43]/80 mt-0.5">
                    {viewingDoc.desc}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <h4 className="text-lg font-serif font-bold text-[#102A43] border-b border-[#102A43]/10 pb-2">
                ...
                {viewingDoc.sections.map((sec, idx) => (
                  <div
                    key={idx}
                    className="p-5 bg-white rounded-2xl border border-[#102A43]/15 space-y-2 shadow-xs"
                  >
                    <div className="flex items-center justify-between">
                      <span className="px-2.5 py-1 rounded bg-[#102A43] text-white text-xs font-mono font-bold">
                        {sec.num}
                      </span>
                      <span className="text-xs font-semibold text-[#B85D19]">
                        Govt Certified Standard
                      </span>
                    </div>
                    <h5 className="font-bold text-[#102A43] text-base sm:text-lg">
                      {sec.title}
                    </h5>
            ...
            <div className="p-5 bg-[#F4F8F9] border-t border-[#102A43]/10 flex flex-wrap items-center justify-between gap-4 shrink-0">
              <span className="text-xs text-[#102A43]/60 font-mono">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#102A43] text-white font-bold text-xs hover:bg-[#0A1C2E] transition-colors"
                >
                  <Download className="w-4 h-4 text-[#C2672B]" />
                  <span>Download File</span>
                </button>
                <button
                  type="button"
                  onClick={() => setViewingDoc(null)}
                  className="px-5 py-2.5 rounded-xl bg-gray-200 text-[#102A43] font-bold text-xs hover:bg-gray-300 transition-colors"
                >
                  Close Reader
                </button>
              </div>
